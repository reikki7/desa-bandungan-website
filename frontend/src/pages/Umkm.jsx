            ...
            .then(data => {
                ...
                switch (filter) {
                    ...
                    case 'Kerajinan':
                        ...
                        break;
                    case 'Edukasi':
                        filteredData = data.filter(umkm => umkm.category_umkm === 'Edukasi');
                        break;
                    case 'Kesenian':
                        filteredData = data.filter(umkm => umkm.category_umkm === 'Kesenian');
                        break;
                    default:
                        filteredData = data;
                }
                ...
                {isMobile ?
                        ...
                        {showFilterMenu &&
                            <div className="absolute z-10 bg-white border border-gray-300 rounded-md top-12">
                                <button
                                    ...
                                    onClick={() => { setFilter("none"); setShowFilterMenu(false); }}
                                >
                                    Semua
                                </button>
                                <button
                                    ...
                                    onClick={() => { setFilter("Pangan"); setShowFilterMenu(false); }}
                                >
                                    Pangan
                                </button>
                                <button
                                    ...
                                    onClick={() => { setFilter("Retail"); setShowFilterMenu(false); }}
                                >
                                    Retail
                                </button>
                                <button
                                    ...
                                    onClick={() => { setFilter("Kerajinan"); setShowFilterMenu(false); }}
                                >
                                    Kerajinan
                                </button>
                                <button
                                    ...
                                    onClick={() => { setFilter("Edukasi"); setShowFilterMenu(false); }}
                                >
                                    Edukasi
                                </button>
                                <button
                                    ...
                                    onClick={() => { setFilter("Kesenian"); setShowFilterMenu(false); }}
                                >
                                    Kesenian
                                </button>
                            </div>
                    ...
                    : (isMediumScreen ?
                        ...
                        <div className="relative flex items-center justify-center mt-5 mr-4 space-x-4 content">
                            <div className={`duration-[360ms] transition-all text-[#004b23] font-bold text-nowrap text-center absolute flex justify-center z-10 items-center text-sm bg-white h-12 rounded-full ${filter === 'none' ? 'w-20 mr-[448px]' : (filter === 'Pangan' ? 'w-24 mr-[267px]' : (filter == "Retail" ? 'w-[85px] mr-[105px]' : (filter == "Kerajinan" ? 'w-28 -mr-[73px]' : (filter == "Edukasi" ? "w-24 -mr-[266px]" : "w-[110px] -mr-[450px]"))))}`}>
                                ...
                                <div className={`absolute transition-opacity duration-300 ${filter !== 'Edukasi' ? 'opacity-0' : 'opacity-100'}`} style={{ height: '1.5rem', lineHeight: '1.5rem' }}>Edukasi</div>
                                <div className={`absolute transition-opacity duration-300 ${filter !== 'Kesenian' ? 'opacity-0' : 'opacity-100'}`} style={{ height: '1.5rem', lineHeight: '1.5rem' }}>Kesenian</div>
                            </div>
                            <div className='p-2 w-[553px] rounded-full bg-[#004b23] relative'>
                                ...
                                <button onClick={() => setFilter('Kerajinan')} className={`px-4 py-2 duration-300 font-bold rounded-full ${filter === 'Kerajinan' ? 'opacity-0' : 'text-white'}`}>Kerajinan</button>
                                <button onClick={() => setFilter('Edukasi')} className={`px-4 py-2 duration-300 font-bold rounded-full ${filter === 'Edukasi' ? 'opacity-0' : 'text-white'}`}>Edukasi</button>
                                <button onClick={() => setFilter('Kesenian')} className={`px-4 py-2 duration-300 font-bold rounded-full ${filter === 'Kesenian' ? 'opacity-0' : 'text-white'}`}>Kesenian</button>
                            </div>
                        </div>
