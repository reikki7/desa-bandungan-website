...
const Navbar = () => {
  ...
  return (
    <div>
      {/* Mobile menu button */}
      <div className="absolute top-0 right-0 block p-4 mt-7 md:hidden">
      ...
      <div className="backdrop-blur-sm justify-center hidden gap-5 p-3 text-lg font-semibold text-white bg-[#14671a] bg-opacity-20 md:flex">
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-50 top-0 left-0 h-full backdrop-blur-sm w-64 bg-[#14671a] md:hidden bg-opacity-65 text-white p-6 transition-all duration-300 ${showSidebar ? "translate-x-0" : "-translate-x-full"}`}
      >
